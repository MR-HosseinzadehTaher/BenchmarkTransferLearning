...
__all__ = ['resnet50', 'resnet50x2', 'resnet50x4']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, width_mult=1, sobel=False):
...
class ResNet_LayerWise(nn.Module):
    ...
    def __init__(self, block, layers, conv, num_classes=1000, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None, width_mult=1, sobel=False):
...
def resnet50_layerwise(conv, pretrained=False, progress=True, **kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = ResNet_LayerWise(Bottleneck, [3, 4, 6, 3], conv, **kwargs)
    return model


def resnet50x2(pretrained=False, progress=True, **kwargs):
  r"""ResNet-50 model from
  `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
  ...
  Args:
      ...
      progress (bool): If True, displays a progress bar of the download to stderr
  """
  model = ResNet(Bottleneck, [3, 4, 6, 3], width_mult=2, **kwargs)
  return model

def resnet50x4(pretrained=False, progress=True, **kwargs):
  r"""ResNet-50 model from
  `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
  ...
  Args:
      ...
      progress (bool): If True, displays a progress bar of the download to stderr
  """
  model = ResNet(Bottleneck, [3, 4, 6, 3], width_mult=4, **kwargs)
  return model
